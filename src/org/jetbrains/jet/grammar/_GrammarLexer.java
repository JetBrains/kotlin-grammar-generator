...
class _GrammarLexer {
    ...
    public void reset(CharSequence buffer, int start, int end, int initialState) {
        zzBuffer = buffer;
        zzBufferArray = fromSequenceWithoutCopying(buffer);
    ...
    public Token advance() throws java.io.IOException {
        ...
        while (true) {
            ...
            switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                case 7: {
                    return new Declaration(yytext().toString(), fileName, line);
                }
                case 11:
                    break;
                case 4: {
                ...
                case 3: {
                    computeLine();
                    return new WhiteSpace(yytext().toString(), fileName, line);
                }
                case 14:
                    break;
                case 9: {
                    computeLine();
                    return new DocComment(yytext().toString(), fileName, line);
                }
                case 15:
                    break;
                case 1: {
                    return new Other(yytext().toString(), fileName, line);
                }
                case 16:
                    break;
                case 10: {
                    return new Annotation(yytext().toString(), fileName, line);
                }
                case 17:
                    break;
                case 8: {
                    computeLine();
                    return new Comment(yytext().toString(), fileName, line);
                }
                case 18:
                    break;
                case 2: {
                    return new Identifier(yytext().toString(), fileName, line);
                }
                case 19:
                    break;
                case 5: {
                    return new StringToken(yytext().toString(), fileName, line);
                }
                case 20:
                    break;
                default:
